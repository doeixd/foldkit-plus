...
InsertText/DeleteText/AddMark/RemoveMark/SetSelection/SplitNode/JoinNode, text
position mapping with split relocation, structural ChangeSets, bounded decode
limits, and inspection. Unknown mark strings load verbatim and
...
(insert/delete/move/set-props), normalization, Form/Bundle integration,
