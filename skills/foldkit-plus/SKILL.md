...
| A domain entity's fields, relations, and derived members, declared once, and typed selections of them (Remote does not read it yet) | the domain declaration | `foldkit-entity` | [entity.md](references/entity.md) |
