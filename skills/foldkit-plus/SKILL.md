...
| Syntax highlighting for a rich-text code block | nobody: tokens are derived decorations, never stored | `foldkit-richtext-code` (0.1.0, early) | [richtext.md](references/richtext.md) |
