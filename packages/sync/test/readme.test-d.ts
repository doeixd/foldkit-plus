...
const Sync = forApplication(WideApp)
...
const Authorized = forApplication(WideApp).withPrincipal<{ readonly role: 'admin' | 'guest' }>()
...
// Lower level: `defineSync` without a Foldkit application to derive from.
