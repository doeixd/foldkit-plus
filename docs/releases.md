...
| --- | --- | --- | --- |
| [`foldkit-agent`](../packages/agent) | 0.2.1 | Published | Protocol-neutral agent contract: projects a Model and Message union into an agent interface. |
| [`foldkit-agent-webmcp`](../packages/agent-webmcp) | 0.2.1 | Published | Browser WebMCP adapter; projects exposed Messages into `document.modelContext`. |
