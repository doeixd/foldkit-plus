...
| [bundle-DX-PLAN.md](./bundle-DX-PLAN.md) | Plan to improve `foldkit-bundle` DX: `make(name, spec)`, a parent scope that infers from Schema values, assembly sugar, args as a Schema, pipeable bundles and links, typed collection keys. |
