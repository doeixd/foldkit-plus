...
/**
 * Every slot style is born in the `app` layer, so the value a view attaches
 * is the one the sheet ships.
 */
const app = Layers.standard.layer('app')
...
export const AddButtonStyle = Style.forSlots(ButtonSlots)(AddButton(), {
  name: 'AddButtonStyle',
  layer: app,
})
